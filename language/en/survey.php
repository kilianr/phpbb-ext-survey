...
$lang = array_merge($lang, array(
	...
	'SURVEY_EXAMPLE_ANSWER'				=> 'Example answer',
	...
	'SURVEY_INVALID_TOPIC_POSTER_RIGHT_TYPE'	=> 'Invalid right for topic poster.',
	'SURVEY_INVALID_VISIBILITY_TYPE'	=> 'Invalid visibilty type.',
	...
	'SURVEY_RANDOM_CHOICE_ORDER'		=> 'Order choices randomly',
	'SURVEY_RANDOM_CHOICE_ORDER_DESC'	=> 'If set, the choices will be ordered randomly for every user.',
	'SURVEY_REOPEN'						=> 'Reopen survey',
	'SURVEY_REOPEN_CONFIRM'				=> 'Are you sure you want to reopen the survey?',
	'SURVEY_REVERSE_ORDER'				=> 'Reverse ordering',
	'SURVEY_RUN'						=> 'Execute',
	...
	'SURVEY_TOPIC_POSTER_RIGHT_DESC'	=> 'Rights for topic poster',
	'SURVEY_TOPIC_POSTER_RIGHT_DESC_' . survey::$TOPIC_POSTER_RIGHT_TYPES['NONE']					=> 'No special rights.',
	'SURVEY_TOPIC_POSTER_RIGHT_DESC_' . survey::$TOPIC_POSTER_RIGHT_TYPES['CAN_SEE_EVERYTHING']		=> 'Can see everything.',
	'SURVEY_TOPIC_POSTER_RIGHT_DESC_' . survey::$TOPIC_POSTER_RIGHT_TYPES['CAN_MANAGE']				=> 'Can manage settings and questions and see everything.',
	'SURVEY_TOPIC_POSTER_RIGHT_DESC_' . survey::$TOPIC_POSTER_RIGHT_TYPES['CAN_EDIT_OTHER_USERS']	=> 'Can manage settings, question and answers (also of other users) and see everything.',
	'SURVEY_TOTAL_ENTRIES'				=> 'Total: %s responses',
	'SURVEY_TYPE'						=> 'Type',
	...
	'SURVEY_VISIBILITY_DESC'			=> 'Visibility',
	'SURVEY_VISIBILITY_DESC_' . survey::$VISIBILITY_TYPES['SHOW_EVERYTHING']	=> 'Show everything',
	'SURVEY_VISIBILITY_DESC_' . survey::$VISIBILITY_TYPES['ANONYMIZE']			=> 'Anonymize',
	'SURVEY_VISIBILITY_DESC_' . survey::$VISIBILITY_TYPES['HIDE_ENTRIES']		=> 'Hide answers (sums will be displayed)',
	'SURVEY_VISIBILITY_DESC_' . survey::$VISIBILITY_TYPES['HIDE_EVERYTHING']	=> 'Hide everything',
	'SURVEY_VISIBILITY_HIDE_DESC_OWNER'	=> 'The answers of this survey are hidden, as topic-starter or due to your permissions you can still see all entries.',
	'SURVEY_VISIBILITY_HIDE_DESC_USER'	=> 'Because the answers of this survey are hidden, you can only see your own entries.',
));
