...
$lang = array_merge($lang, array(
	...
	'SURVEY_CAP'						=> 'Cap (if summing up, users can no longer respond if their answer would cause the sum to exceed the cap. Leave blank for no cap).',
	...
	'SURVEY_QUESTION_SUM_SHOW_AVERAGE'	=> 'Show the average of sum divided by answers (depending on sum-type in percent or not)',
