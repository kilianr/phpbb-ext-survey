...
$lang = array_merge($lang, array(
	...
	'SURVEY_DELETE_ALL_CONFIRM'	=> 'Do you really want to delete this survey? All stored data (answers, questions, available information) will be lost and cannot be restored.',
	...
	'SURVEY_DISABLE_CONFIRM'	=> 'Do you really want to disable the survey? The data (answers, questions, available information) will be kept in the database and the survey can be reactivated anytime',
	'SURVEY_DISABLE_EXPLAIN'	=> 'The survey will not be displayed in the topic anymore, but the data (answers, questions, available information) will be kept in the database.',
	'SURVEY_ENTRY_DELETION_CONFIRM'	=> 'Do you really want to cancel your membership in this survey?',
	'SURVEY_HIDE'			=> 'Hide survey',
	'SURVEY_HIDE_RESULTS'		=> 'Hide results',
