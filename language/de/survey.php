...
$lang = array_merge($lang, array(
	...
	'SURVEY_EXAMPLE_ANSWER'				=> 'Beispielantwort',
	...
	'SURVEY_INVALID_QUESTION_NO_LABEL'	=> 'Frage ungültig: Kein Name gesetzt.',
	'SURVEY_INVALID_QUESTION_SUM_BY'	=> 'Frage ungültig: zu zählender Antwort-Text fehlt.',
	'SURVEY_INVALID_QUESTION_SUM_TYPE'	=> 'Frage ungültig: Unbekannter Summen-Typ.',
	'SURVEY_INVALID_QUESTION_TYPE'		=> 'Frage ungültig: Unbekannter Typ.',
	'SURVEY_INVALID_SHOW_ORDER_TYPE'	=> 'Ungültiger Sortier-Typ.',
	...
	'SURVEY_INVALID_TOPIC_POSTER_RIGHT'	=> 'Ungültiges Recht für Themen-Ersteller.',
	'SURVEY_INVALID_VISIBILITY_TYPE'	=> 'Ungültiger Sichtbarkeits-Typ.',
	...
	'SURVEY_LABEL'						=> 'Name',
	'SURVEY_MANAGE_QUESTIONS'			=> 'Fragen verwalten',
	'SURVEY_MANAGE_QUESTIONS_DESC'		=> 'Hiermit fügst du neue Fragen in den Bogen ein oder bearbeitest bestehende.',
	...
	'SURVEY_QUESTION_ADD_AS_NEW'		=> 'Als neue Frage hinzufügen',
	'SURVEY_QUESTION_ALREADY_ADDED'		=> 'Die Frage %s wurde diesem Fragebogen bereits hinzugefügt',
	'SURVEY_QUESTION_LOAD'				=> 'Frage laden',
	'SURVEY_QUESTION_MODIFY'			=> 'Frage bearbeiten',
	...
	'SURVEY_RANDOM_CHOICE_ORDER'		=> 'Zufällige Ordnung der Möglichkeiten',
	'SURVEY_RANDOM_CHOICE_ORDER_DESC'	=> 'Falls gesetzt, werden die Auswahlmöglichkeiten für jeden Benutzer zufällig angeordnet.',
	...
	'SURVEY_REVERSE_ORDER'				=> 'Sortierung umkehren',
	...
	'SURVEY_TOPIC_POSTER_RIGHT_DESC'	=> 'Rechte des Themen-Erstellers',
	'SURVEY_TOPIC_POSTER_RIGHT_DESC_' . survey::$TOPIC_POSTER_RIGHTS['NONE']					=> 'Keine besonderen Rechte.',
	'SURVEY_TOPIC_POSTER_RIGHT_DESC_' . survey::$TOPIC_POSTER_RIGHTS['CAN_SEE_EVERYTHING']		=> 'Kann alles sehen.',
	'SURVEY_TOPIC_POSTER_RIGHT_DESC_' . survey::$TOPIC_POSTER_RIGHTS['CAN_MANAGE']				=> 'Kann Einstellungen und Fragen managen sowie alles sehen.',
	'SURVEY_TOPIC_POSTER_RIGHT_DESC_' . survey::$TOPIC_POSTER_RIGHTS['CAN_EDIT_OTHER_USERS']	=> 'Kann Einstellungen, Fragen und Antworten (auch anderer Benutzer) managen sowie alles sehen.',
	'SURVEY_TYPE'						=> 'Typ',
	...
	'SURVEY_VISIBILITY_DESC'			=> 'Sichtbarkeit',
	'SURVEY_VISIBILITY_DESC_' . survey::$VISIBILITY_TYPES['SHOW_EVERYTHING']	=> 'Alles anzeigen',
	'SURVEY_VISIBILITY_DESC_' . survey::$VISIBILITY_TYPES['ANONYMIZE']			=> 'Anonymisieren',
	'SURVEY_VISIBILITY_DESC_' . survey::$VISIBILITY_TYPES['HIDE_ENTRIES']		=> 'Antworten verstecken (Summen werden angezeigt)',
	'SURVEY_VISIBILITY_DESC_' . survey::$VISIBILITY_TYPES['HIDE_EVERYTHING']	=> 'Alles verstecken',
	'SURVEY_VISIBILITY_HIDE_DESC_OWNER'	=> 'Die Antworten des Fragebogens sind versteckt, als Topicstarter oder aufgrund deiner Rechte kannst du dennoch alle Einträge sehen.',
	'SURVEY_VISIBILITY_HIDE_DESC_USER'		=> 'Die Antworten des Fragebogens sind versteckt, daher kannst du nur deine eigenen Einträge sehen.',
));
